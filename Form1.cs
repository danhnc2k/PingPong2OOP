...
namespace PingPongGame
{
    public partial class Form1 : Form
    {
        ...
        public void SetGame()
        {
            ...
            CircleThing = new Ball(Ball, PlayGround, player1, player2, BallXPos, BallYPos, timer1);                                                     //Đối với biến Ball thì khi di chuyển cần biết vị trí của thanh đờ từ 2 người chơi và biến timer1 cho việc nếu game kết thúc thì pause game
